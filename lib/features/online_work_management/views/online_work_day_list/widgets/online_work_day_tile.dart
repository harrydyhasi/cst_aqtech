...
class OnlineWorkDayTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final formattedSumDay = formatDayController.formatOnlineWorkDay(onlineWorkDay.sumDay);
    final updateOnlineWorkDayController = Get.put(UpdateOnlineWorkDayController());
    final approvalStatus = onlineWorkDay.approvalStatus; // Đã sửa lại
    final approvalStatusString = HeplerFunction.convertEnumToString(approvalStatus);
      ...
      return Slidable(
        endActionPane: ActionPane(motion: const DrawerMotion(), children: [
          SlidableAction(onPressed: ((context) {
            updateOnlineWorkDayController.deleteOnlineWorkDay(onlineWorkDay.id.toString());
          }),
          ...
          SlidableAction(onPressed: ((context) {
            ...
            Get.to(() => OnlineWorkDayDetailScreen(selectedOnlineWorkDay: onlineWorkDay));
          }),
        ...
        child: InkWell(
          onTap: () => {
            Get.to(() => ApprovalOnlineWorkDayScreen(selectedOnlineWorkDay: onlineWorkDay))
            },
          child: Container(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          MyFormatter.formatDate(onlineWorkDay.dateFrom.toString()),
                        ),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        const Icon(Icons.calendar_month_outlined),
                        Text(
                          MyFormatter.formatDate(onlineWorkDay.dateTo.toString()),
                        ),
                      ],
                    ),
