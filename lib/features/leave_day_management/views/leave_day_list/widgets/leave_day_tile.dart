  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Slidable(
        ...
        child: InkWell(
          onTap: () => {Get.to(() => ApprovalLeaveDayScreen(selectedLeaveDay: leaveDay))},
          child: Container(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          MyFormatter.formatDate(leaveDay.dateFrom.toString()),
                        ),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        const Icon(Icons.calendar_month_outlined),
                        Text(
                          MyFormatter.formatDate(leaveDay.dateTo.toString()),
                        ),
                      ],
                    ),
